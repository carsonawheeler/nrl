...
export const TEAM_BRAND = {
  barracudas: { abbr: 'BAR', conf: 'F', c: '#14b8c4', mono: true,  tag: 'Deep Strikers' },
  ...
  guardians:  { abbr: 'GRD', conf: 'F', c: '#c99a3a', mono: true,  tag: 'The Wall' },
  turtles:    { abbr: 'TRT', conf: 'H', c: '#12a06a', mono: false, tag: 'Shellshock' },
  vipers:     { abbr: 'VPR', conf: 'H', c: '#8b46c9', mono: true,  tag: 'Venom' },
  scorpions:  { abbr: 'SCP', conf: 'H', c: '#d1443f', mono: true,  tag: 'The Sting' },
  vortex:     { abbr: 'VTX', conf: 'H', c: '#5566e0', mono: true,  tag: 'The Storm' },
