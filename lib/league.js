...
export async function getLeagueData() {
  ...
  const AWARDS = {
    ...
    dpoy: top5(players, (p) => p.sv / availGp(p), (v) => v.toFixed(1)),
    tmoy: top5(players, (p) => p.a / availGp(p), (v) => v.toFixed(1)),
    soy: top5(players, (p) => p.sh / availGp(p), (v) => v.toFixed(1)),
  ...
  return { TEAMS, PLAYERS, COACHES, MOVES, S1PICKS, S2PICKS, S3PICKS, CHAMPS, RINGS, RESULTS, STATS, STATTEAMS, FREEAGENTS, NOTIFS, BOXSCORES, AWARDS, PLAYOFF_ODDS };
}
